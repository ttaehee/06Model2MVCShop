...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<input type="hidden" name="buyerId" value="user13">
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		/////////////////////// EL / JSTL 적용으로 주석 처리 //////////////////////// --%>
			...
			<c:forEach items="${purchase.paymentOption}" var="paymentOption">
				<option value="${paymentOption}" ${paymentOption == "1" ? 'selected' : ''}>현금구매</option>
			</c:forEach>
			<c:forEach items="${purchase.paymentOption}" var="paymentOption">
				<option value="${paymentOption}" ${paymentOption == "1" ? 'selected' : ''}>현금구매</option>
			</c:forEach>
